...
export default function KambazNavigation() {
  return (
    ...
    bottom-0 top-0 d-none d-md-block bg-black z-2">
      ...
      <Link to="/Kambaz/Account" id="wd-account-link" className="list-group-item text-center border-0 bg-black text-white"> <FaRegCircleUser className="fs-1 text text-white" /><br />
      Account</Link>
